...
class MainActivity : AppCompatActivity() , IMainView {
    ...
    private val presinter = MainPresinter()
    ...
    private fun setup() {
        presinter.view= this
        presinter.getUserInfo()

    }


    override fun onweatherDataSuccess(weatherData: WeatherData) {
        binding.textviewTemp.text = weatherData.toString()
    }
...
//                Toast.makeText(this, "tepm : $temp summer", Toast.LENGTH_SHORT).show()
//            } else {
//                binding.imageClothes.setImageResource(getListOfImgWinterClothes()[0])
//                Toast.makeText(this, "tepm : $temp winter", Toast.LENGTH_SHORT).show()
//
//
//            }
//        }
